 ...
 * executes the makeNoise method on each animal in the pack. It also outputs the 
 * geometric mean of the animal pack.
 */
public class AnimalPackTest {
	...
	public static void main (String[] args) {
		...
		System.out.println("What is the geometric mean of the animal pack?");
		System.out.println(pack.geoMean());
		System.out.println(AnimalPack.staticGeoMean(pack));
